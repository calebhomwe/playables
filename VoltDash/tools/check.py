"""Static gate on the single-file game (VOLT DASH).
...
runner constants, the persistence keys and the debug hook wiring.
...
# --- game contract ------------------------------------------------------
for need in ("window.__volt_debug", "requestAnimationFrame", "getContext",
             "visibilitychange", "localStorage", "vd_rec", "vd_snd",
             'id="play"', 'id="again"', 'id="resume"', 'id="s-over"',
             'id="energyFill"', 'id="sndBtn"',
             "SPEED0", "SPEED1", "SPEED_RAMP", "GRAVITY", "HOP_V",
             "SLIDE_TIME", "SLIDE_H", "STAND_H", "ENERGY_MAX",
             "DRAIN0", "DRAIN1", "CELL_GAIN", "HIT_COST", "DASH_COST",
             "DASH_TIME", "DASH_MULT", "SECTOR_DIST", "SECTOR_NAMES",
             "spawnCellAt", "forceObstacle", "setEnergy", "setSpeed",
             "clearTrack", "setSpawner", "advance("):
    if need not in src:
