"""Static gate on the single-file game (RUNG RUNNER).
...
ladder-runner constants, the persistence keys and the debug hook wiring.
...
# --- game contract ------------------------------------------------------
for need in ("window.__rung_debug", "requestAnimationFrame", "getContext",
             "visibilitychange", "localStorage", "rr_rec", "rr_snd",
             'id="play"', 'id="again"', 'id="resume"', 'id="s-over"',
             "CAM_BACK", "WALL_UNIT", "RUNG_Y", "ZONE_DIST",
             "SPEED0", "SPEED1", "DRAW_DIST", "ZONE_NAMES",
             "spawnRungAt", "forceWall", "forceSaw", "setStack", "advance("):
    if need not in src:
